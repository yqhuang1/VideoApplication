...
public class AttentionAdapter extends BaseAdapter {
    ...
    public AttentionAdapter(Context context, List<ExpertEntity> list, String flag) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (!flag.equals("persion") || flag.equals("fans")) {
            holder.focusTv.setVisibility(View.GONE);
        }
        ...
        if ("0".equals(lastMark)) {
            holder.focusTv.setBackgroundResource(R.drawable.focus_tv_bg);
            holder.focusTv.setText("+关注");
        } else {
            holder.focusTv.setBackgroundResource(R.drawable.unfocus_tv_bg);
