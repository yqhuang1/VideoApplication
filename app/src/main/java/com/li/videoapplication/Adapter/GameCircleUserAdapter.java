 ...
 * 游戏圈子 玩家适配器
 */
public class GameCircleUserAdapter extends BaseAdapter {
    ...
    public GameCircleUserAdapter(Context context, List<ExpertEntity> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.game_circle_user_item, null);
            holder.flag = (ImageView) convertView.findViewById(R.id.game_circle_user_item_flag);
            holder.nameTv = (TextView) convertView.findViewById(R.id.game_circle_user_item_name);
            holder.videoTv = (TextView) convertView.findViewById(R.id.game_circle_user_item_video_tv);
            holder.fansTv = (TextView) convertView.findViewById(R.id.game_circle_user_item_fans_tv);
            holder.rankTv = (TextView) convertView.findViewById(R.id.game_circle_user_item_rank_tv);
            holder.manifestoTv = (TextView) convertView.findViewById(R.id.game_circle_user_item_manifesto);
            holder.focusTv = (TextView) convertView.findViewById(R.id.game_circle_user_item_focus_tv);
        ...
        if ("0".equals(lastMark)) {
            ...
            holder.focusTv.setTextColor(context.getResources().getColor(R.color.search_result_focus));
        } else {
            holder.focusTv.setBackgroundResource(R.drawable.focus_stroke_bg);
            holder.focusTv.setText("已关注");
            holder.focusTv.setTextColor(context.getResources().getColor(R.color.search_result_default));
        }
        return convertView;
    }
