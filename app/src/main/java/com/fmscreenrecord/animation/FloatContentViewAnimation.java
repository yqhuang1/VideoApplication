 ...
 * @author WYX
 */
public class FloatContentViewAnimation implements OnClickListener {
    ...
    public FloatContentViewAnimation(Context context, View view,
    ...
    // 用于显示录制时间
    public Handler handler_timedisplay = new Handler() {
                ...
                if (isOpen == false) {// 如果处于展开状态
                    for (int i = 0; i < btns.length; i++) {
                        ...
                        if (((UpperDistance) < (YLengt + YHeight))) {
                            ...
                            // TODO
                            if (i == 0) {// 修订三个按钮的X,Y距离
                                xLenth = (float) (radius * 0.45);
                                yLenth = (float) (radius * 0.9);

                            } else if (i == 1) {
                                xLenth = (float) (radius * 1.0);
                                yLenth = (float) (radius * 0.4);
    ...
    public void setFloatContentViewLocation(Context context) {
        ...
        if (ExApplication.moveX == -1 && ExApplication.moveY == -1) {// 首次打开浮窗，使用默认位置的的坐标
            ...
            timeText.setX(mwidth - radius + btn_width / 2 + 5);
            timeText.setY(mheight / 2);
            ...
            timeText.setX(ExApplication.moveX + 5);
            timeText.setY(ExApplication.moveY);
    ...
    private void initButtons(View view) {
        ...
        btns[2] = (ImageView) view.findViewById(MResource.getIdByName(mContext,
                "id", "bt_pause"));
        btns[3] = (ImageView) view.findViewById(MResource.getIdByName(mContext,
                "id", "float_layout_botton_SC"));

        btn_menu = (ImageView) view.findViewById(MResource.getIdByName(
                mContext, "id", "bt_float_ico"));
        timeText = (TextView) view.findViewById(MResource.getIdByName(mContext,
                "id", "record_anmin_tv"));
