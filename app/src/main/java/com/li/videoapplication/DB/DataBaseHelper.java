...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //下载的视频
        db.execSQL("create table download(id INTEGER PRIMARY KEY AUTOINCREMENT,video_id varchar(50)," +
                "name varchar(50),title varchar(100),imgUrl varchar(100),downloadUrl varchar(100),playUrl varchar(100)," +
                "qn_key varchar(50),youku_url varchar(50),download_state varchar(20))");
