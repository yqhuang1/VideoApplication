...
public class HttpUtils {
	...
	public static final String IMG_URL = "http://apps.ifeimo.com";
	public static final String BASE_URL = "http://apps.ifeimo.com/home";

	public static final String Video_URL = "http://apps.ifeimo.com/Home";
	...
	public static String getAutoGift(String id) {
		return BASE_URL + "/member/getMyPackageInfo.html?id=" + id
				+ "&member_id=" + ExApplication.MEMBER_ID;
	};

	public static String getMyGift(String page) {
		return BASE_URL + "/member/getMyPackageList.html?member_id="
				+ ExApplication.MEMBER_ID + "&page=" + page;
	}
	...
	public static String completeMission(String id) {
		return BASE_URL + "/member/finishTask.html?id=" + id + "&member_id="
	...
	public static final String getUserVideoId(String id) {
		return Video_URL + "/Video/getVidById.html?member_id=" + id;
	}
	...
	public static final String getCollectVideo(String member_id, String id) {
		return BASE_URL + "/video/collect.html?id=" + id + "&member_id="
				+ member_id;
	}
	...
	public static final String getCollectVideoList(String id, String page) {
		return BASE_URL + "/member/collectVideoList.html?member_id=" + id
				+ "&page=" + page;
	}
	 ...
	 * @return
	 */
	public static final String getRecommendList(String page, String type_id,
			String type) {
		// return
		// BASE_URL+"/video/recommendList.html?page="+page+"&type_id="+type_id;
		return BASE_URL + "/video/list.html?page=" + page + "&sort=" + type
				+ "&type_id=" + type_id;
	}
	...
	public static final String getGiftUrl(String member_id, String id) {
		return BASE_URL + "/member/claimPackage.html?member_id=" + member_id
				+ "&id=" + id;
	}
	...
	public static final String getVedioFlowerUrl(String id, String member_id) {
		return BASE_URL + "/video/flower.html?id=" + id + "&member_id="
				+ member_id;
	}
	 ...
	 * @return
	 */
	public static final String getSearchVideoUrl(String key, String type,
			String page) {
		return BASE_URL + "/search/searchVideo.html?name=" + key + "&sort="
				+ type + "&page=" + page;
	}
	...
	public static final String getSearchGiftUrl(String name, String page) {
		return BASE_URL + "/search/searchPackage.html?name=" + name + "&page="
				+ page;
	}
	...
	public static final String getSearchMisssionUrl(String name, String page) {
		return BASE_URL + "/search/searchTask.html?name=" + name + "&page="
				+ page;
	}
	...
	public static final String getFindUser(String nickname, String page) {
		return BASE_URL + "/search/searchMember.html?name=" + nickname
				+ "&page=" + page;
	}
	 ...
	 */
	/*
	 * public static String httpPost(String name,String descripe,String
	 * time,String id,String fileUrl, String...params) { String rs=""; try {
	 * HttpClient httpClient= new DefaultHttpClient();////生成一个http客户端对象
	 * HttpParams httpparams=httpClient.getParams();
	 * HttpConnectionParams.setConnectionTimeout(httpparams, 20000);//设置连接超时时间
	 * HttpConnectionParams.setSoTimeout(httpparams, 600000);//设置请求超时 HttpPost
	 * post=new HttpPost(params[0]);//客户端向服务器发送请求,返回一个响应对象
	 * 
	 * MultipartEntity entity = new MultipartEntity(); //
	 * entity.addPart("data",new StringBody(content));
	 * 
	 * if (!fileUrl.equals("")){ File file = new File(fileUrl);
	 * Log.e("Img",fileUrl); entity.addPart("files",new FileBody(file)); }
	 * 
	 * entity.addPart("member_id",new StringBody(ExApplication.MEMBER_ID));
	 * entity.addPart("name",new StringBody(name)); entity.addPart("url",new
	 * StringBody(id)); entity.addPart("descriptoin",new StringBody(descripe));
	 * entity.addPart("time_length",new StringBody(time));
	 * post.setEntity(entity); // post.setEntity(new UrlEncodedFormEntity(param,
	 * HTTP.UTF_8)); HttpResponse response =new
	 * DefaultHttpClient().execute(post);
	 * if(response.getStatusLine().getStatusCode()==200) {
	 * rs=EntityUtils.toString(response.getEntity()); }
	 * 
	 * } catch (Exception e) { Log.e("httpPost",e.toString()); rs=""; }
	 * Log.e("HttpPost_Response",rs); return rs;
	 * 
	 * }
	 */
	 ...
	 * @param time_length
	 *            视频时长
	 * @param postVideoInfoUrl
	 *            post请求地址
	 * @return
	 */
	public static String httpPost(String member_id, String video_id,
			String video_name, String game_name, String time_length,
			String postVideoInfoUrl) {
		String rs = "";
	 ...
	 * @return
	 */
	public static String postImage(Context context, String httpUrl,
			String fileUrl) {
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				...
				Log.e("response", res);
				// return
				// EncryptUtil.decrypt(EntityUtils.toString(response.getEntity()));
				return res;
			}
